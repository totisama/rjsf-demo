...
import './App.css'
import { FieldTemplate } from './components/templates/field-template'
import { TitleCounterWidget } from './components/widgets/title-counter-widget'
import { SmartDateWidget } from './components/widgets/smart-date-widget'
import { EstimateHoursWidget } from './components/widgets/estimate-hours-widget'
import { PriorityWidget } from './components/widgets/priority-widget'
...
function App() {
  ...
  const [todos, setTodos] = useState<
    Array<FormValues & { id: string; createdAt: string }>
  >([])

  const handleSubmit = (event: IChangeEvent) => {
    const data = event.formData as FormValues
